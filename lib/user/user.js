...
function Warble(wid, username, date, message, attachment, atUser){
  this.wid = wid;
  this.username = username;
  this.date = date;
...
var warbledb = [
  new Warble ('1', 'Xian', '4/3/13 at 2:15pm', 'Another test', 'none', ' '),
  new Warble ('2', 'Xian', '4/3/13 at 2:28pm', 'Hello. This is a test', 'none', ' '),
  new Warble ('3', 'Eric', '4/3/13 at 4:50pm', 'Immah Here', 'none', 'Xian'),
  new Warble ('4', 'Xian', '4/3/13 at 5:06pm', 'Hehe filtering werks', 'none', ' '),
  new Warble ('5', 'Ryan', '4/3/13 at 5:30pm', 'Followeeerrrsss!!!!', 'none', 'Xian')
