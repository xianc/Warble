...
exports.getWarble = function (props, errorcb, succcb) {
  var findWarble = Warble.find({ where : props });
  findWarble.success(succcb);
  findWarble.error(errorcb);
};
...
exports.getFollower = function (props, errorcb, succcb) {
var findUser = Follower.find({ where : props });
  findUser.success(succcb);
  findUser.error(errorcb);
};
